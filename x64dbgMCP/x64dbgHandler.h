...
#pragma managed
    ...
    public:
        ...
        [Description(
            ...
            "  run_command : { command, wait? } -- raw x64dbg command (https://github.com/x64dbg/x64dbg/blob/2026.05.27/src/dbg/x64dbg.cpp#L110-L514); wait=true uses DbgCmdExecDirect\n"
        )]
